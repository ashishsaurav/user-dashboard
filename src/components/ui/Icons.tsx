...
export const EyeIcon: React.FC<IconProps & { isVisible: boolean }> = ({
  width = 16,
  height = 16,
  strokeWidth = 2,
  className = "",
...
export const ViewGroupIcon: React.FC<IconProps> = ({
  width = 16,
  height = 16,
  strokeWidth = 2,
  className = "",
...
export const ThemeIconLight: React.FC<IconProps> = ({
  width = 24,
  height = 24,
  strokeWidth = 2,
  className = "",
...
export const ThemeIconDark: React.FC<IconProps> = ({
  width = 24,
  height = 24,
  strokeWidth = 2,
  className = "",
